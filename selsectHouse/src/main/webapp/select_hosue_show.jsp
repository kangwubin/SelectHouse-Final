				...
				<div>
					<div class="xmgs_tab">
						<a href="./show_index.jsp"> <span data-id="-1"
							class="xmgsyabHover">意向等级公示<font></font></span>
					...
					<tbody>
						<tr>
							<td align="center" bgcolor="#e7e3e3"><table width="1200"
									...
									<tbody>
										<tr>
											<td align="center" bgcolor="#e7e3e3"><span class="fb">序号</span></td>
											...
											<td align="center" bgcolor="#e7e3e3"><span class="fb">选房结果</span></td>
										</tr>
										<tr>
											<td>
								...
								</div> <script type="text/javascript"> xmgsload();</script>
