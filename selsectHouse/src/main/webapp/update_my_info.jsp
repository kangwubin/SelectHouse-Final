...
<body>
	...
	<div class="content bgwhite  sfyzDiv">
		<div class="prel tc pad_30 pad_b10">
			<span class="size18 color_e34156">欢迎访问XATU商品住房用户个人信息修改平台</span>
		...
		<div class="bd bgFDF8EA prel pad_20 mag_t80 sfrzTip">
			<div class="size18 color_e34156" align="center">
				友情提示：请修改您所需要修改的信息，并确保其他信息正确...........</div>
		 </div>
		<div align="center">
<table algin="center" width="292"><td height="166">
<table algin="center" width="292">
  <tr>
      <td width="100" height="24">姓    名：</td>
      <td width="192" height="24">
         <input type="text" name="username" size=25></td>
  </tr>
  <tr>
       <td width="100" height="24" >证件类型：</td>
       <td width="192" height="24">
       <select name="edu">
  ...
  <tr>  
      <td width="100" height="24">证件号码：</td>
      <td width="192" height="24"><input type="text" name="IDcard" size=25 maxlength=15></td>
  </tr>
  <tr>
       <td height="24">电话号码：</td>
       <td height="24"><input type="text" size=25 name="email"></td>
  </tr>
   <tr>
       <td width="100" height="24">家庭类型：</td>
       <td width="192" height="24">
       <select name="edu">
           <option value="刚需家庭">刚需家庭</option>
           <option value="普通家庭">普通家庭</option>
       </select></td>
   <tr>  
      <td width="100" height="24">密    码：</td>
      <td width="192" height="24"><input type="password" name="userkey1" size=15 maxlength=15></td>
  </tr>
  <tr>
      <td width="100" height="24">旧密码:</td>
      <td width="192" height="24">
         <input type="password" name="username" size=15></td>
  </tr>
  <tr>  
      <td width="100" height="24">新密码：</td>
      <td width="192" height="24"><input type="password" name="userkey1" size=15 maxlength=15></td>
  </tr>
  <tr>  
      <td width="100" height="24">确认新密码：</td>
      <td width="192" height="24"><input type="password" name="userkey1" size=15 maxlength=15></td>
  </tr>
