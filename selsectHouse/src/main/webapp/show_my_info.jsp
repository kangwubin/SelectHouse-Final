...
<body>
	...
	<div class="content bgwhite  sfyzDiv">
		<div class="prel tc pad_30 pad_b10">
			...
			<div class="fR size16 vm mag_r20 mag_b10 return_Btn weight700"
				onclick="window.location.href='index2.jsp'">返回首页</div>
			<div class="clear"></div>
		</div>
		<div class="grayLine"></div>
		<div class="bd bgFDF8EA prel pad_20 mag_t80 sfrzTip">
			<div class="size18 color_e34156" align="center">
				友情提示：1.请确认您的信息是否正确，点击确认提交之后，个人信息将不可更改......<br>2.请记住您的密码，以便下次登录.......</div>
		</div>
		<div align="center">
		<div align="center">    
		<!-- ----------------------------------------------------------------------------------- -->
		...
		<%
				...
				String pwd = 	 s.getAttribute("pwd").toString();
		
					Purchaser	 purchaser =  (Purchaser)request.getAttribute("purchaser");
						if (purchaser != null && purchaser.getPASSWORD() !=null) {
		%>
    ...
    <tr>
      ...
      <td width="200"><label for="textfield"></label>
        <input type="text" name="textfield" id="textfield" value="<%=purchaser.getREALNAME()%>" readonly="readonly" /></td>
         <td>证件类型：</td>
      <td> 
      <input type="text" name="card_type" id="textfield4" placeholder="证件类型"  readonly="readonly"
       value="<%=purchaser.getCARDTYPE()%>"/>	
      </td>
    </tr>
    ...
    <tr>
      ...
      value="<%=purchaser.getCARDCODE()%>"/></td>
       <td>电话号码：</td>
      <td><label for="textfield3"></label>
      <input type="text" name="textfield3" id="textfield3" placeholder="11位数字"
      value="<%=purchaser.getMOBILEPHONE()%>" /></td>
    </tr>
    ...
    <tr>
      ...
      value="<%=purchaser.getPURCHASETYPE()%>"/>
      </td>
       <td>密码：</td>
      <td><label for="textfield4"></label>
      <input type="text" name="textfield4" id="textfield4" placeholder="8-15位" 
      value="<%=pwd%>"/></td>
      </tr>
      ...
      <td>意向登记号：</td>
      <td>
      <input type="text" name="family_type" id="textfield4" placeholder="意向登记号"  readonly="readonly"
      value="<%= purchaser.getROCKNUMBER()%>"/>
      </td>
      </tr>
      
  </table>
  <table width="1000" height="60" border="1" >
  <tr align="center">
		<td width="80" height="1" ><a>购房流程详情</a> </td>
		<td width="80" height="1">撤销购房申请</td>
		<td width="80" height="1"><a href="ok_submit_my_info.jsp">确认提交</a></td>
		<td width="80" height="1"><a href="update_my_info.jsp">个人密码修改</a></td>
		</tr>
	</table>
		<%
						}
