...
<!DOCTYPE html>
<!-- saved from url=(0042)http://zfyxdj.xa.gov.cn/zfrgdjpt/xmgs.aspx -->
			...
			<div>
				<div class="xmgs_tab">
					<a href="./show_index.jsp"> <span
						data-id="-1" class="xmgsyabHover2">意向登记公示<font></font></span>
								...
								<tbody>
									<tr>
										<td align="center" bgcolor="#e7e3e3"><span
											style="font-size: 18px;"> 楼盘号</span></td>
										<td align="center" bgcolor="#e7e3e3"><span
											style="font-size: 18px;">用户姓名</span></td>
										<td align="center" bgcolor="#e7e3e3"><span
											style="font-size: 18px;">购房类型</span></td>
										<td align="center" bgcolor="#e7e3e3"><span
											style="font-size: 18px;">审核状态</span></td>
									</tr>
									<tr>
										<td>
									...
									<tr>
										...
										<td align="center"><%=pur.getPURCHASETYPE() %></td>
										<td align="center"><%=pur.getVERIFYSTATUS() %></td>
									</tr>
									<%
										}
									%>
