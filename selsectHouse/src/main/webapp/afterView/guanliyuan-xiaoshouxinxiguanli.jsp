            ...
            <div class="bgwhite  mag_tb">
                ...
                <div>
                    <div class="xmgs_tab">
                        ...
                        <span data-id="6" class="xmgsyabHover1" >摇号时间发布<font></font></span>
                        </a>
                ...
                <div class=" mag_b20 pad_20">
                   ...
                   <!--  在这里加东西 --> 
                   <!-- servlet实现 -->  
                   <form action="/selsectHouse/HouseServlet?method=houseAdd" method="post">
                   <%
               ...
               <%
				...
				%>
            	<tr>
                <td><input value="<%=hou.getEATATE_NAME() %>" name="name"></td>
       
                <td> <input value="<%=hou.getLOTIERY_START_TIME() %>" name="starTime"> </td>
                <td> <input value="<%=hou.getLOTIERY_END_TIME() %>" name="endTime">  </td>
                <td> <input value="<%=hou.getLOTIERY_START_TIME() %>" name="starTime1"> </td>
                <td> <input value="<%=hou.getLOTIERY_END_TIME() %>" name="entdTime1">  </td>
                <td><input type="submit" value="发布时间" ></a>
                </td>
