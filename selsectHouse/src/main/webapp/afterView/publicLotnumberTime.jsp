	...
	<div class="wrapper">
		...
		<div id="div_table_content">
			...
			<tr>
				...
				<td align="center">摇号时间</td>
				<td align="center">提交</td>
			</tr>
			<c:forEach items="${houseList}" var="houseInfo">
				<form action="SellInfoManage" method="post">
					<input type="hidden" name="operate" value="issueRockTime" /> <input
						type="hidden" name="EATATE_ID" value="${houseInfo.EATATE_ID}" /> <input
						type="hidden" name="EATATE_NAME" value="${houseInfo.EATATE_NAME}" />
				<tr style="color: #999999; font-weight: bold;">
					...
					<td style="width: 140px;"><input name="LOTIERY_TIME" type="date" step="01" value="${houseInfo.LOTIERY_TIME}"/></td>
