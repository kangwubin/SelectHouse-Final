    ...
    <img src="/selsectHouse/afterView/img/topimg00.jpg">
        ...
        <div class="content">
            <div class="bgwhite  mag_tb">
                ...
                <%
                    for(Purchaser hou:purchasers){
                %>
            <tr>
                <td><%=hou.getREALNAME() %></td>
                <td><%=hou.getCARDCODE() %></td>
                <td><%=hou.getMOBILEPHONE() %></td>
                <td><select>
                 <option value="1"><%=hou.getPURCHASETYPE() %></option>
                <option value="2">刚需家庭</option>
                ...
                <td><select>
                    <option value="1"><%=hou.getVERIFYSTATUS() %></option>
                ...
                <td><a href="/selsectHouse/StaffServlet?method=staffDelet&id">提交</a>
                </td>
