	...
	<div class="content bgwhite  sfyzDiv">
		...
		<script type="text/javascript">
			function checkForm() {
				...
				if (!(/^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{4}$/.test(card_id))) {
		...
		<!-- 后台获取数据--------------------------------------------------------------- -->
		<form action="/selsectHouse/PurchaserServlet?method=purChaseraddInfo" method="post" onsubmit="return checkForm()">
		<div align="center">
